...
The goal is to transform raw banking data into actionable business insights through SQL analysis and an interactive Power BI dashboard.

---

## 🎯 Business Objective

The analysis focuses on answering key banking business questions:
...
- Which account/customer segments contribute most to the loan portfolio?
